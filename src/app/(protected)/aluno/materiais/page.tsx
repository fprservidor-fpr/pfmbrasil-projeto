    ...
    <div className="space-y-6 md:space-y-8 max-w-6xl mx-auto px-4 md:px-0 pb-10">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6 md:space-y-8">
        <div className="relative -mx-4 px-4 md:mx-0 md:px-0 overflow-x-auto pb-2 scrollbar-hide">
          <TabsList className="bg-zinc-900/50 border border-zinc-800 p-1 rounded-2xl h-14 flex w-max md:w-full min-w-full">
            <TabsTrigger value="pfm" className="rounded-xl data-[state=active]:bg-emerald-600 data-[state=active]:text-white font-black text-[10px] uppercase tracking-widest h-full px-4 md:px-8 flex-1 whitespace-nowrap">
              <ShieldCheck className="w-4 h-4 mr-2" />
              Material PFM
            </TabsTrigger>
            <TabsTrigger value="biblia" className="rounded-xl data-[state=active]:bg-blue-600 data-[state=active]:text-white font-black text-[10px] uppercase tracking-widest h-full px-4 md:px-8 flex-1 whitespace-nowrap">
        ...
        <TabsContent value="capa" className="mt-0 outline-none">
          ...
          >
            ...
            <div className="relative group overflow-hidden md:overflow-visible">
              ...
              <div className="relative bg-zinc-900/50 border border-zinc-800 rounded-3xl p-6 md:p-8 flex flex-col items-center justify-center text-center space-y-6 min-h-[300px] md:min-h-[400px]">
                <div className="w-16 h-16 md:w-20 md:h-20 bg-amber-500/10 rounded-2xl flex items-center justify-center border border-amber-500/20 text-amber-500">
