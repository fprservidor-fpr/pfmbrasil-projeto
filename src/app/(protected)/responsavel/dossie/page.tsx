...
export default function ResponsavelDossiePage() {
                    ...
                    <div key={missao.id} className="bg-slate-950/50 rounded-xl p-4 border border-white/5 group hover:border-violet-500/30 transition-all">
                      ...
                      {missao.missoes_materiais && missao.missoes_materiais.length > 0 && (
                        <div className="flex flex-wrap gap-1.5 pt-2 border-t border-white/5">
                          {missao.missoes_materiais.map(({ study_materials: m }: any) => (
                            <a 
                              key={m.id} 
                              href={m.file_url} 
                              target="_blank" 
          ...
          <div className="bg-slate-900/50 border border-white/5 rounded-2xl p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-slate-950/50 rounded-xl border border-white/5">
                ...
                <span className="font-bold text-red-400 text-sm">-{demeritos}</span>
              </div>
